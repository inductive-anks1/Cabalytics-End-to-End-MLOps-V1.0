...
if __name__ == "__main__":
    data_path = Path('/home/inductive_anks/Backup Files/CS and AI/AI and ML/Data_Science_Projects/Cabalytics-End-to-End-MLOps/data/raw/Cab_Data_Train.csv')  # Pathlib will handle the correct file path format
